                ...
                >
                    <div className="text-white px-6 w-full">
                        <div className="flex flex-col">
                            <span><span className="font-bold">{user?.username}</span><span className="ml-3 text-sm">comment: </span></span>
                            <span className="flex flex-row text-sm justify-between"><span className="line-clamp-1">"{props?.notification?.text}"</span><span className="text-sm text-gray-400">{convertTimeToParis(props?.notification?.updatedAt.toString())}</span></span>
                        </div>
                    </div>
                    <img
                        src={post?.image?.url}
